...
def qwen3_235b_a22b_pretrain_64gpu_gb200_bf16_config() -> ConfigContainer:
    """Qwen3 235B-A22B pretrain: 64× GB200, BF16, PP=8 EP=8."""
...
def qwen3_235b_a22b_pretrain_64gpu_gb200_fp8cs_config() -> ConfigContainer:
    """Qwen3 235B-A22B pretrain: 64× GB200, FP8 current-scaling, PP=8 EP=8."""
    cfg = qwen3_235b_a22b_pretrain_config()
...
def qwen3_235b_a22b_pretrain_64gpu_gb200_fp8mx_config() -> ConfigContainer:
    """Qwen3 235B-A22B pretrain: 64× GB200, MXFP8, PP=8 EP=8."""
    cfg = qwen3_235b_a22b_pretrain_config()
...
def qwen3_30b_a3b_pretrain_8gpu_gb200_fp8cs_config() -> ConfigContainer:
    """Qwen3 30B-A3B pretrain: 8× GB200, FP8 current-scaling, EP=8."""
    cfg = qwen3_30b_a3b_pretrain_config()
    cfg.mixed_precision = _perf_precision("fp8_cs")
    cfg.model.bias_activation_fusion = True
    cfg.model.recompute_granularity = None
...
def qwen3_30b_a3b_pretrain_8gpu_gb200_nvfp4_config() -> ConfigContainer:
    ...
    is disabled here.
    """
    cfg = qwen3_30b_a3b_pretrain_8gpu_gb200_fp8cs_config()
    cfg.mixed_precision = _perf_precision("nvfp4")
    cfg.comm_overlap.tp_comm_overlap = False
...
def qwen3_30b_a3b_pretrain_32gpu_gb200_fp8cs_config() -> ConfigContainer:
    ...
    cfg = _with_global_batch_size(qwen3_30b_a3b_pretrain_8gpu_gb200_fp8cs_config(), 2048)
    # Keep process settings next to the recipe so users can see the exact benchmark environment.
    cfg.env_vars = {
        **COMMON_PERF_ENV_VARS,
        # CUDA stream scheduling for this model and parallel layout.
...
def qwen3_30b_a3b_pretrain_16gpu_gb200_bf16_dev_config() -> ConfigContainer:
...
def qwen3_30b_a3b_pretrain_16gpu_gb200_fp8mx_partial_cg_dev_config() -> ConfigContainer:
...
def qwen3_30b_a3b_pretrain_16gpu_gb200_fp8mx_paged_stash_dev_config() -> ConfigContainer:
...
def qwen3_235b_a22b_pretrain_128gpu_gb200_fp8mx_paged_stash_dev_config() -> ConfigContainer:
...
def qwen3_235b_a22b_pretrain_128gpu_gb200_fp8mx_partial_cg_dev_config() -> ConfigContainer:
